...
interface DeletePageModalProps {
  page: { id: string; title: string; isHomepage: boolean } | null
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
  isDeleting?: boolean
 ...
 * DeletePageModal
 *
 * A confirmation modal for deleting pages.
 * Shows warning if attempting to delete homepage.
 *
 * Features:
...
export function DeletePageModal({
  ...
  // Don't render on server, if not mounted, not open, or no page
  if (!mounted || !isOpen || !page) return null

  const modalContent = (
    <div
      className={`modal-overlay ${isClosing ? 'closing' : 'entering'}`}
      onClick={handleBackdropClick}
      data-testid="delete-page-modal-overlay"
    >
      <div
      ...
      >
        ...
        <div className="modal-header">
          ...
          <button
            ...
            disabled={isDeleting}
            aria-label="Close"
            data-testid="delete-page-modal-close-btn"
          >
            <svg
              width="20"
              height="20"
        ...
        <div className="modal-body">
          <div id="delete-modal-description" className="delete-modal-message">
            ...
            {page.isHomepage && (
              <p className="warning-text">
                This is your homepage. If you delete it, another page will be promoted to homepage automatically.
              </p>
            )}
          ...
          <div className="modal-actions">
            <button
              ...
              onClick={handleClose}
              disabled={isDeleting}
              data-testid="delete-page-modal-cancel-btn"
            >
              Cancel
            </button>
            <button
              ...
              onClick={onConfirm}
              disabled={isDeleting}
              data-testid="delete-page-modal-confirm-btn"
            >
              {isDeleting ? (
                <>
