    ...
    <div className="dashboard-overview">
      ...
      <div className="dashboard-overview__actions">
        ...
        <div className="dashboard-overview__actions-grid">
          {/* New Page */}
          <Link href="/admin/pages?action=create" className="dashboard-action-card">
          ...
          {/* New Category */}
          <Link href="/admin/categories?action=create" className="dashboard-action-card">
            <div className="dashboard-action-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="3" width="7" height="7" />
                <rect x="14" y="3" width="7" height="7" />
          ...
          {/* New Project */}
          <Link href="/admin/categories?action=create-project" className="dashboard-action-card">
            <div className="dashboard-action-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="2" y="7" width="20" height="14" rx="2" ry="2" />
                <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />
